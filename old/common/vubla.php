...
function get_content() {
	...
	if(ini_get('allow_url_fopen')) {
		$source = file_get_contents('http://api.vubla.com/oscommerce/?host='.$_SERVER['HTTP_HOST']);
	} else {
		//Get content
		$ch	= curl_init();
		curl_setopt ($ch, CURLOPT_URL, 'http://api.vubla.com/oscommerce/?host='.$_SERVER['HTTP_HOST']);
