...
class Vubla_SearchAutocomplete_Block_Autocomplete extends Mage_Catalog_Block_Product {
    ...
    protected function getProductsGroupedByCategories() {
        ...
        usort($groupedProducts, array('Vubla_SearchAutocomplete_Block_Autocomplete', 'cmpCategories'));
    ...
    protected function _sortProducts($products) {
        ...
        if ($sortOrder == 'name_asc') {
            usort($products, array('Vubla_SearchAutocomplete_Block_Autocomplete', 'cmpNames'));
        } elseif ($sortOrder == 'name_desc') {
            usort($products, array('Vubla_SearchAutocomplete_Block_Autocomplete', 'cmpNames'));
            $products = array_reverse($products);
        } elseif ($sortOrder == 'price_desc') {
            usort($products, array('Vubla_SearchAutocomplete_Block_Autocomplete', 'cmpPrices'));
