...
class Vubla_SearchAutocomplete_Helper_Data extends Mage_Core_Helper_Abstract {
    
    const XML_SEARCHAUTOCOMPLETE_ENABLED = 'vubla_tweaks/searchautocomplete/enabled';
    const XML_SEARCHAUTOCOMPLETE_HIGHLIGHTING_ENABLED = 'vubla_tweaks/searchautocomplete/highlighting_enabled';
    const XML_SEARCHAUTOCOMPLETE_SEPARATOR_ENABLED = 'vubla_tweaks/searchautocomplete/separator_enabled';
    
    const XML_SEARCHAUTOCOMPLETE_SUGGESTED_SEARCHES = 'vubla_tweaks/searchautocomplete/suggested_searches';
    const XML_SEARCHAUTOCOMPLETE_SUGGESTED_SEARCHES_RESULTS = 'vubla_tweaks/searchautocomplete/suggested_searches_results';
    
    const XML_SEARCHAUTOCOMPLETE_SEARCH_PRODUCTS = 'vubla_tweaks/searchautocomplete/search_products';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_IMAGE_SIZE = 'vubla_tweaks/searchautocomplete/product_image_size';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SEARCH_RESULTS = 'vubla_tweaks/searchautocomplete/product_search_results';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SEARCH_RESULTS_SORT_ORDER = 'vubla_tweaks/searchautocomplete/product_search_results_sort_order';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SEARCH_RESULT_FIELDS = 'vubla_tweaks/searchautocomplete/product_search_result_fields';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SHORT_DESCRIPTION_SIZE = 'vubla_tweaks/searchautocomplete/product_short_description_size';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_TITLE_SIZE = 'vubla_tweaks/searchautocomplete/product_title_size';
    
    const XML_SEARCHAUTOCOMPLETE_SEARCH_CATEGORIES = 'vubla_tweaks/searchautocomplete/search_categories';
    const XML_SEARCHAUTOCOMPLETE_CATEGORY_SEARCH_RESULTS = 'vubla_tweaks/searchautocomplete/category_search_results';    
    
    const XML_SEARCHAUTOCOMPLETE_SEARCH_CMS = 'vubla_tweaks/searchautocomplete/search_cms';
    const XML_SEARCHAUTOCOMPLETE_CMS_SEARCH_RESULT_FIELDS = 'vubla_tweaks/searchautocomplete/cms_search_result_fields';

    const XML_SEARCHAUTOCOMPLETE_SEARCH_BLOG = 'vubla_tweaks/searchautocomplete/search_blog';

    const XML_SEARCHAUTOCOMPLETE_SHOW_PRODUCT_RESULTS_GROUPED_BY_CATEGORIES = 'vubla_tweaks/searchautocomplete/show_product_results_grouped_by_categories';
    ...
    public function isSearchCmspro() {
        return Mage::getStoreConfigFlag('vubla_tweaks/searchautocomplete/search_cmspro') && (string)Mage::getConfig()->getModuleConfig('MW_Cmspro')->active == 'true';
    }
    
    public function getCmsproSearchResultFields() {
        return explode(',', Mage::getStoreConfig('vubla_tweaks/searchautocomplete/search_cmspro_result_fields'));
    }
    public function getPopUpDelay() {
        return (int)Mage::getStoreConfig('vubla_tweaks/searchautocomplete/popup_delay');
    }
    ...
    public function sanitizeContent($page) {
        ...
        $text = preg_replace_callback('@{{.*?}}@si','Vubla_SearchAutocomplete_Helper_Data::loadWidget', $text);        
