...
class Vubla_Adminhtml_Model_Support extends Varien_Object
{
    const XML_PATH_SUPPORT_EMAIL = 'vubla/support/email';
    const XML_PATH_SUPPORT_NAME = 'vubla/support/name';
    const XML_PATH_SUPPORT_EMAIL_TEMPLATE = 'vubla/support/template';
