...
class Vubla_Adminhtml_Block_System_Config_Form_Fieldset_Mageworx_Support
	extends Vubla_Adminhtml_Block_System_Config_Form_Fieldset_Mageworx_Abstract
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$fields = array(
            ...
            array('type' => 'label', 'name' => 'send', 'after_element_html' => '<div class="right"><button type="button" class="scalable save" onclick="vublaSupport();">'.$this->__('Send').'</button></div><div class="notice" id="ajax-response"></div>'),
  		);
    ...
    {
        $ajaxUrl = $this->getUrl('vubla/support');
        $html = parent::_getFooterHtml($element);
        $html = '<h4>'.$this->__('Contact Vubla Support Team or visit <a href="%s">%s</a> for additional information', 'http://www.mageworx.com/', 'MageWorx.com').'</h4>' . $html;
